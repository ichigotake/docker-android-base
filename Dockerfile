...
ENV ANDROID_SDK_REVISION 24.1.2
ENV ANDROID_SDK_URL http://dl.google.com/android/android-sdk_r${ANDROID_SDK_REVISION}-linux.tgz
ENV ANDROID_SDK_COMPONENTS tools,platform-tools,build-tools-$ANDROID_SDK_REVISION,android-22,android-20,extra-android-support,extra-android-m2repository,extra-google-m2repository
